...
This checks to see if the deployed byte-code matches this version of the Strike Protocol.
...
(async function() {
  ...
  console.log(`Matching sToken at ${address} with ${JSON.stringify(conf)}`);
  ...
  await saddle.match(address, 'SErc20Immutable', deployArgs);
